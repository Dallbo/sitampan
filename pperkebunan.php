                    ...
                    <div class="row">
                        ...
                        <table class="table">
                            <div class="d-flex align-items-center justify-content-center">
                                <h4><b style="color:black;">Panen Perkebunan</b></h4>
                            </div>
                            <thead class="bg-success">
                                <tr>
                                    <th scope="col"><h7 class="text-white">No</h7></th>
                                    <th scope="col"><h7 class="text-white">Tanggal</h7></th>
                                    <th scope="col"><h7 class="text-white">Kecamata</h7></th>
                                    <th scope="col"><h7 class="text-white">Desa</h7></th>
                                    <th scope="col"><h7 class="text-white">Luas Lahan</h7></th>
                                    <th scope="col"><h7 class="text-white">Kadar Produktivitas</h7></th>
                                    <th scope="col"><h7 class="text-white">Provinsi</h7></th>
                                    <th scope="col"><h7 class="text-white">Harga</h7></th>
